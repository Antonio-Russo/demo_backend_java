...
public class JwtUtils {
    ...
    @Value("${JWT_HOUR_EXPIRATION}")
    private Long expiration;

    private static final long serialVersionUID = -2310197651108950415L;
    ...
    private Date generateExpirationDate() {
        return new Date(System.currentTimeMillis() + 1000 * 60 * 60 * expiration);
    }
